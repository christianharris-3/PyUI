...
class UI:
    ...
    def maketextbox(self,x,y,title,width,height,menu='main',border=4,titlesize=50,titleheight=-1,titlecenter=True,textsize=40,textcenter=False,titlefont='default',titlebold=False,col=(150,150,150),backingcol=-1,titlecol=(0,0,0),textcol=(0,0,0),upperborder=0,lowerborder=0,rightborder=0,leftborder=0,selectcol=-1,selectbordersize=2,selectshrinksize=0,roundedcorners=0,clicktype=0,textoffsetx=0,textoffsety=0,font='default',bold=False,cursorsize=-1):
        ...
        self.textboxes.append(TEXTBOX(x,y,width,height,border,titleheight,roundedcorners,title,titlecenter,titlesize,titlecol,titlefont,titlebold,backingcol,textcenter,textsize,textcol,col,upperborder,lowerborder,rightborder,leftborder,selectcol,selectbordersize,selectshrinksize,cursorsize,menu,clicktype,titleimage,textoffsetx,textoffsety,font,bold,self))
...
class TEXTBOX:
    ...
    def gentext(self,ui):
        ...
        for a in self.chrcorddatalined:
            self.chrcorddata+=a
        self.textimage = ui.maketextlined(self.text,self.textsize,self.textcol,self.backingcol,self.font,self.width-self.border*2-self.leftborder-self.rightborder,self.bold,center=self.textcenter)
