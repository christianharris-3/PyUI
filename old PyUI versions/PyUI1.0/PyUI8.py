...
class UI:
    ...
    def makebutton(self,x,y,text,textsize,command,menu='main',col=(150,150,150),bordercol=-1,hovercol=-1,textcol=(0,0,0),width=-1,height=-1,border=3,verticalspacing=0,horizontalspacing=8,roundedcorners=0,clicktype=0,textoffsetx=0,textoffsety=0,font='default',bold=False,layer=1,ID='default',returnobj=False):
        if font=='default': font=self.defaultfont
        ...
        if ID == 'default':
            ID = text
        obj = BUTTON(x,y,text,textsize,command,menu,col,bordercol,hovercol,textcol,width,height,border,roundedcorners,clicktype,textimage,textoffsetx,textoffsety,font,bold,layer,ID,self)
        if returnobj:
            return obj
        else:
    ...
    def maketext(self,x,y,text,size,menu='main',col=(0,0,0),center=True,font='default',bold=False,maxwidth=-1,backingborder=4,backingcol=(255,255,255),backingdraw=0,backingwidth=-1,backingheight=-1,roundedcorners=0,layer=1,ID='default',antialiasing=True,returnobj=False):
        if font == 'default': font = self.defaultfont
        if backingcol != (255,255,255):
            backingdraw = True
        if ID == 'default':
            ID = text
        obj = TEXT(x,y,text,size,menu,col,center,font,bold,maxwidth,backingborder,backingcol,backingdraw,backingwidth,backingheight,roundedcorners,antialiasing,layer,ID,self)
        if returnobj:
            return obj
        else:
...
class BUTTON:
    def __init__(self,x,y,text,textsize,command,menu,col,bordercol,hovercol,textcol,width,height,border,roundedcorners,clicktype,textimage,textoffsetx,textoffsety,font,bold,layer,ID,ui):
        self.x = x
        self.y = y
        self.text = text
...
class TEXT:
    def __init__(self,x,y,text,size,menu,col,center,font,bold,maxwidth,backingborder,backingcol,backingdraw,backingwidth,backingheight,roundedcorners,antialiasing,layer,ID,ui):
        self.x = x
        self.y = y
        self.text = text
        self.size = size
