...
class UI:
    ...
    def maketextbox(self,x,y,title,width,height,menu='main',border=4,titlesize=50,titleheight=-1,titlecenter=True,textsize=40,textcenter=False,titlefont='default',titlebold=False,col=(150,150,150),backingcol=-1,titlecol=(0,0,0),textcol=(0,0,0),selectcol=-1,selectbordersize=2,selectshrinksize=0,roundedcorners=0,clicktype=0,textoffsetx=0,textoffsety=0,font='default',bold=False,cursorsize=-1):
        if font=='default': font=self.defaultfont
        ...
        self.textboxes.append(TEXTBOX(x,y,width,height,border,titleheight,roundedcorners,title,titlecenter,titlesize,titlecol,titlefont,titlebold,backingcol,textcenter,textsize,textcol,col,selectcol,selectbordersize,selectshrinksize,cursorsize,menu,clicktype,titleimage,textoffsetx,textoffsety,font,bold,self))
...
class TEXTBOX:
    def __init__(self,x,y,width,height,border,titleheight,roundedcorners,title,titlecenter,titlesize,titlecol,titlefont,titlebold,backingcol,textcenter,textsize,textcol,textbackingcol,selectcol,selectbordersize,selectshrinksize,cursorsize,menu,clicktype,titleimage,textoffsetx,textoffsety,font,bold,ui):
        self.x = x
        self.y = y
    ...
    def gentext(self,ui):
        ...
        if self.typingcursor != -1: self.linecenter = [self.chrcorddata[self.typingcursor][1][0]+self.chrcorddata[self.typingcursor][2][0]/2,self.chrcorddata[self.typingcursor][1][1]]
            ...
            else: linecenter = [self.width/2,self.textsize*0.3]
    ...
    def draw(self,screen,scale,clicking): 
        ...
        if self.selected: pygame.draw.rect(screen,self.selectcol,rectscaler(self.selectrect,scale),self.selectbordersize)
