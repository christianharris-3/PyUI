            ...
            for i,b in enumerate(self.labeleddata[a]):
                if b[0] == 'text':
                    if self.boxwidth == -1:
                        ...
                        if type(self.boxwidth) == int:
                            if a==0: img = ui.rendertextlined(b[1],self.titletextsize,self.titletextcol,self.titleboxcol,self.titlefont,self.boxwidth,self.titlebold,center=self.titlecenter)
                            else: img = ui.rendertextlined(b[1],self.boxtextsize,self.boxtextcol,self.boxcol,self.boxfont,self.boxwidth,self.boxbold,center=self.boxcenter)
                        else:
                            if a==0: img = ui.rendertextlined(b[1],self.titletextsize,self.titletextcol,self.titleboxcol,self.titlefont,self.boxwidth[i],self.titlebold,center=self.titlecenter)
                            else: img = ui.rendertextlined(b[1],self.boxtextsize,self.boxtextcol,self.boxcol,self.boxfont,self.boxwidth[i],self.boxbold,center=self.boxcenter)
                    rec = img.get_rect()
