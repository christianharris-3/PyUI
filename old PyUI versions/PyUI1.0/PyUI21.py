...
class UI:
    ...
    def animations(self):
        for a in self.animations:
            a[0]-=1
    def makeanimation(self,ID,startpos,endpos,movetype='linear',length=30):
    ...
    def rendershaperect(self,name,size,col,backcol):
        vals = self.getshapedata(name,['rounded','width'],[0,200])
        rounded = vals[0]
        width = vals[1]
        surf = pygame.Surface((size*width,size))
        surf.fill(backcol)
    ...
    def rendershapebezier(self,name,size,col,backcol):
        data = [['test thing', [[[(200, 100), (490, 220), (300, 40), (850, 340)], [(850, 340), (300, 200), (450, 350), (340, 430)], [(340, 430), (310, 250), (200, 310), (200, 100)]], [[(380, 440), (540, 360), (330, 240), (850, 370)], [(850, 370), (380, 440)]]]],
                ...
                ['heart', [[[(390, 510), (160, 330), (350, 210), (390, 340)], [(390, 340), (410, 210), (610, 320), (390, 510)]]]],
                ]
    ...
    def makebutton(self,x,y,text,textsize,command=emptyfunction,menu='main',col='default',bordercol=-1,hovercol=-1,textcol='default',img='none',colorkey=(255,255,255),runcommandat=0,width=-1,height=-1,border=3,clickdownsize=3,verticalspacing=0,horizontalspacing=8,roundedcorners=0,clicktype=0,textoffsetx=0,textoffsety=0,toggle=True,togglecol=-1,togglehovercol=-1,toggleable=False,drawifoff=True,bindtoggle=[],dragable=False,center=True,font='default',bold=False,layer=1,ID='default',returnobj=False):
        ...
        if ID == 'default':
            ID = 'button '+text
        obj = BUTTON(x,y,text,textsize,command,menu,col,bordercol,hovercol,textcol,img,colorkey,runcommandat,width,height,border,clickdownsize,roundedcorners,clicktype,textoffsetx,textoffsety,toggle,togglecol,togglehovercol,toggleable,bindtoggle,drawifoff,dragable,font,bold,layer,ID,self)
        self.addid(ID,obj)
        if returnobj:
            return obj
        else:
    ...
    def makecheckbox(self,x,y,textsize=80,command=emptyfunction,menu='main',text='',col=(255,255,255),bordercol='default',hovercol=-1,textcol='default',img='tick',colorkey=(255,255,255),runcommandat=0,width=-1,height=-1,border=4,clickdownsize=1,verticalspacing=-15,horizontalspacing=-15,roundedcorners=0,clicktype=0,textoffsetx=0,textoffsety=0,toggle=True,togglecol=-1,togglehovercol=-1,toggleable=True,drawifoff=False,bindtoggle=[],dragable=False,center=True,font='default',bold=False,layer=1,ID='tickbox',returnobj=False):
        ...
        self.makebutton(x,y,text,textsize,command,menu,col,bordercol,hovercol,textcol,img,colorkey,runcommandat,width,height,border,clickdownsize,verticalspacing,horizontalspacing,roundedcorners,clicktype,textoffsetx,textoffsety,toggle,togglecol,togglehovercol,toggleable,drawifoff,bindtoggle,dragable,center,font,bold,layer,ID,returnobj)
            
    def maketextbox(self,x,y,title,width,lines=1,menu='main',height=-1,border=4,titlesize=50,titleheight=-1,titlecenter=True,textsize=40,textcenter=False,titlefont='default',titlebold=False,col='default',backingcol=-1,titlecol='default',textcol='default',upperborder=0,lowerborder=0,rightborder=0,leftborder=0,center=True,chrlimit=1000,enterreturns=False,command=emptyfunction,commandifenter=True,commandifkey=False,selectcol=-1,selectbordersize=2,selectshrinksize=0,roundedcorners=0,clicktype=0,textoffsetx=0,textoffsety=0,font='default',bold=False,cursorsize=-1,layer=1,ID='default',returnobj=False):
        if font=='default': font=self.defaultfont
        if textcol == 'default': textcol = self.defaulttextcol
...
class BUTTON:
    def __init__(self,x,y,text,textsize,command,menu,col,bordercol,hovercol,textcol,img,colorkey,runcommandat,width,height,border,clickdownsize,roundedcorners,clicktype,textoffsetx,textoffsety,toggle,togglecol,togglehovercol,toggleable,bindtoggle,drawifoff,dragable,font,bold,layer,ID,ui):
        self.x = x
        self.y = y
        self.text = text
