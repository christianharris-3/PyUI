...
##            a.resetcords()
    ...
    def rendershapebezier(self,name,size,col,backcol,failmessage):
        data = [['test thing', [[[(200, 100), (490, 220), (300, 40), (850, 340)], [(850, 340), (300, 200), (450, 350), (340, 430)], [(340, 430), (310, 250), (200, 310), (200, 100)]], [[(380, 440), (540, 360), (330, 240), (850, 370)], [(850, 370), (380, 440)]]]],
                ...
                ['blobby', [[[(445.0, 325.0), (585.0, 525.0), (725.0, 215.0), (665.0, 135.0)], [(665.0, 135.0), (575.0, 85.0), (235.0, -5.0), (345.0, 215.0)], [(345.0, 215.0), (515.0, 185.0), (745.0, 105.0), (445.0, 325.0)]]]],
                ]
...
class GUI_ITEM:
    ...
    def smartcords(self,x='',y='',startset=True,accountscroll=False):
        ...
        if x!='':
            self.x = x
            if startset: self.startx = ((self.x+scr[0])*self.dirscale[0]+self.objanchor[0]*self.scale-self.anchor[0])/self.scale-self.master[0].x
        if y!='':
            self.y = y
            if startset: self.starty = ((self.y+scr[1])*self.dirscale[1]+self.objanchor[1]*self.scale-self.anchor[1])/self.scale-self.master[0].y
