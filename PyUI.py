...
class UI:
    ...
    def makebutton(self,x,y,text,textsize,command,menu='main',col=(150,150,150),bordercol=-1,hovercol=-1,textcol=(0,0,0),width=-1,height=-1,border=3,verticalspacing=0,horizontalspacing=8,roundedcorners=0,clicktype=0,textoffsetx=0,textoffsety=0,font='default',bold=False,returnobj=False):
        ...
        if hovercol==-1:
            ...
            hovercol = ncol
        obj = BUTTON(x,y,text,textsize,command,menu,col,bordercol,hovercol,textcol,width,height,border,roundedcorners,clicktype,textimage,textoffsetx,textoffsety,font,bold,self)
        if returnobj:
            return obj
        else:
    ...
    def maketable(self,x,y,data='empty',titles=[],menu='main',rows=5,colomns=3,boxwidth=-1,boxheight=50,spacing=10,boxcol=(150,150,150),boxtextcol=(0,0,0),boxtextsize=-1,boxcenter=True,font='default',bold=False,titlefont=-1,titlebold=-1,titleboxcol=(150,150,150),titletextcol=(0,0,0),titletextsize=-1,titlecenter=True,linesize=2,linecol=(130,130,130),roundedcorners=0,returnobj=False):
        if font == 'default': font = self.defaultfont
        ...
        obj = TABLE(x,y,rows,colomns,data,titles,boxwidth,boxheight,spacing,menu,boxcol,boxtextcol,boxtextsize,boxcenter,font,bold,titlefont,titlebold,titleboxcol,titletextcol,titletextsize,titlecenter,linesize,linecol,roundedcorners,self)
        if returnobj:
            return obj
        else:
            self.tables.append(obj)
    def maketext(self,x,y,text,size,menu='main',col=(0,0,0),center=True,font='default',bold=False,maxwidth=-1,backingborder=4,backingcol=(255,255,255),backingdraw=0,backingwidth=-1,backingheight=-1,roundedcorners=0,antialiasing=True):
        if font == 'default': font = self.defaultfont
        if backingcol != (255,255,255):
            backingdraw = True
        self.texts.append(TEXT(x,y,text,size,menu,col,center,font,bold,maxwidth,backingborder,backingcol,backingdraw,backingwidth,backingheight,roundedcorners,antialiasing,self))
...
class BUTTON:
    def __init__(self,x,y,text,textsize,command,menu,col,bordercol,hovercol,textcol,width,height,border,roundedcorners,clicktype,textimage,textoffsetx,textoffsety,font,bold,ui):
        self.x = x
        self.y = y
        self.text = text
    ...
    def gentext(self,ui):
        self.textimage = ui.rendertext(self.text,self.textsize,self.textcol,self.font,self.bold)
    def refresh(self,ui):
...
class TABLE:
    def __init__(self,x,y,rows,colomns,data,titles,boxwidths,boxheight,spacing,menu,boxcol,boxtextcol,boxtextsize,boxcenter,boxfont,boxbold,titlefont,titlebold,titleboxcol,titletextcol,titletextsize,titlecenter,linesize,linecol,roundedcorners,ui):
        self.x = x
        self.y = y
        self.rows = rows
...
class TEXT:
    def __init__(self,x,y,text,size,menu,col,center,font,bold,maxwidth,backingborder,backingcol,backingdraw,backingwidth,backingheight,roundedcorners,antialiasing,ui):
        self.x = x
        self.y = y
        self.text = text
        self.size = size
